  ...
  var Key = (function () {
    ...
    _createClass(Key, [{
      ...
      value: function isPageUp() {
        return this.keyCode === _mobiledocKitUtilsKeycodes['default'].PAGEUP;
      }
    }, {
      key: 'isPageDown',
      value: function isPageDown() {
        return this.keyCode === _mobiledocKitUtilsKeycodes['default'].PAGEDOWN;
      }
    }, {
      key: 'isInsert',
      value: function isInsert() {
        return this.keyCode === _mobiledocKitUtilsKeycodes['default'].INS;
      }
    }, {
      key: 'isClear',
      value: function isClear() {
        return this.keyCode === _mobiledocKitUtilsKeycodes['default'].CLEAR;
      }
    }, {
      key: 'isPause',
      value: function isPause() {
        return this.keyCode === _mobiledocKitUtilsKeycodes['default'].PAUSE;
      }
    }, {
      key: 'isSpace',
      ...
      value: function isTab() {
        return !this.hasAnyModifier() && this.keyCode === _mobiledocKitUtilsKeycodes['default'].TAB;
      }
    }, {
      key: 'isEnter',
