...
define('tests/unit/utils/key-test', ['exports', '../../test-helpers', 'mobiledoc-kit/utils/key', 'mobiledoc-kit/utils/keycodes'], function (exports, _testHelpers, _mobiledocKitUtilsKey, _mobiledocKitUtilsKeycodes) {
  ...
  test('firefox: non-printable are treated as not printable', function (assert) {
    var KEYCODES = [_mobiledocKitUtilsKeycodes['default'].DOWN, _mobiledocKitUtilsKeycodes['default'].HOME, _mobiledocKitUtilsKeycodes['default'].END, _mobiledocKitUtilsKeycodes['default'].PAGEUP, _mobiledocKitUtilsKeycodes['default'].PAGEDOWN, _mobiledocKitUtilsKeycodes['default'].INS, _mobiledocKitUtilsKeycodes['default'].CLEAR, _mobiledocKitUtilsKeycodes['default'].PAUSE, _mobiledocKitUtilsKeycodes['default'].ESC];
